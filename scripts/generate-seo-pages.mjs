...
const defaultImage = `${siteUrl}/assets/sap-training-hero.png`;

const organization = {
  "@type": "EducationalOrganization",
  name: "SV CurioTech",
  url: `${siteUrl}/`,
  logo: `${siteUrl}/assets/sv-curiotech-logo.png`,
...
const pages = [
  ...
  page("sap-training-in-canada", "SAP Training in Canada | Online SAP Course & Placement Help | SV CurioTech", "Join SAP Training in Canada with SV CurioTech. Learn SAP FICO, MM, SD, PP, ABAP, BASIS, HCM, SuccessFactors and S/4HANA online with hands-on practice and placement help.", "SV CurioTech offers SAP training in Canada through live online instructor-led classes, practical SAP S/4HANA server access, recordings for revision, real business scenarios, SAP FICO, SAP MM, SAP SD, SAP PP, SAP ABAP, SAP SuccessFactors, interview preparation, resume help and placement assistance. Learners can join from Toronto, Vancouver, Calgary, Ottawa, Montreal, Edmonton, Mississauga, Brampton and other Canadian cities.", { h1: "SAP Training in Canada", schemas: [courseSchema("SAP Training in Canada", "Online SAP training in Canada covering SAP FICO, MM, SD, ABAP, PP, BASIS, SuccessFactors and S/4HANA.", `${siteUrl}/sap-training-in-canada`, "Canada", "Online"), faqSchema()] }),
  page("sap-fico-training-in-toronto", "SAP FICO Training in Toronto, Canada | SV CurioTech", "Join SAP FICO Training in Toronto with SV CurioTech. Learn SAP FI and CO through practical finance process examples, SAP S/4HANA practice, interview preparation and career guidance.", "SV CurioTech offers SAP FICO training in Toronto for graduates, accountants, commerce learners, finance professionals, auditors, working professionals and freshers who want to convert accounting and finance knowledge into SAP Finance skills. The course explains SAP FI and SAP CO in practical language, covering General Ledger, Accounts Payable, Accounts Receivable, Asset Accounting, Bank Accounting, tax concepts, cost centers, profit centers, internal orders, planning, allocations, profitability analysis, financial reporting and management reporting. Learners understand how vendor invoices, customer billing, payments, procurement, sales, inventory and business operations create financial postings in SAP. The training is built for online SAP FICO learners in Toronto and Canada who want SAP S/4HANA practice, business scenario explanations, configuration awareness, interview preparation, resume guidance, mock interview support and career counselling for SAP FICO consultant, SAP FI consultant, SAP CO consultant, finance analyst, ERP support and SAP functional roles.", { h1: "SAP FICO Training in Toronto", keywords: "SAP FICO Training in Toronto, SAP FICO Course Toronto, SAP FI Training Toronto, SAP CO Training Toronto, Online SAP FICO Training Canada, SAP Finance Course Toronto, SAP S/4HANA Finance Toronto, SAP FICO Interview Preparation Toronto", schemas: [courseSchema("SAP FICO Training in Toronto", "Online SAP FICO training in Toronto covering SAP FI, SAP CO, accounting, controlling, AP, AR, GL, reporting and integration scenarios.", `${siteUrl}/sap-fico-training-in-toronto`, ["Toronto", "Greater Toronto Area", "Canada"], "Online"), faqSchema()] }),
  page("sap-course-in-toronto", "SAP Course in Toronto | SAP Training Canada | SV CurioTech", "Join SV CurioTech for SAP Course in Toronto with live online SAP training, S/4HANA practice, SAP FICO, MM, SD, PP, ABAP, SuccessFactors and placement support.", "SV CurioTech offers a SAP Course in Toronto through live online classes for learners in Toronto and the Greater Toronto Area. The course supports SAP FICO, MM, SD, PP, ABAP, BASIS, HCM, SuccessFactors and S/4HANA learning with hands-on practice, module selection guidance, certification preparation direction, interview readiness and placement support.", { h1: "SAP Course in Toronto", schemas: [courseSchema("SAP Course in Toronto", "Online SAP course in Toronto covering SAP FICO, MM, SD, PP, ABAP, HCM, SuccessFactors and S/4HANA.", `${siteUrl}/sap-course-in-toronto`, ["Toronto", "Greater Toronto Area", "Canada"], "Online"), faqSchema()] }),
  page("sap-training-in-vancouver", "SAP Training in Vancouver, Canada | Online SAP Course | SV CurioTech", "Join SAP Training in Vancouver, Canada with SV CurioTech. Learn SAP FICO, MM, SD, PP, ABAP, HCM, SuccessFactors, Ariba, S/4HANA, Basis, BW/HANA and BTP through practical online training and career guidance.", "SV CurioTech offers SAP training in Vancouver, Canada through practical live online classes for students, working professionals, career switchers and learners who want enterprise ERP skills. The course supports SAP FICO, SAP MM, SAP SD, SAP PP, SAP HCM, SuccessFactors, SAP ABAP, SAP Ariba, SAP S/4HANA, SAP Basis, SAP BW/HANA and SAP BTP learning with SAP navigation, process flows, configuration concepts, business cases, project-based learning, interview preparation, resume guidance, small-batch training and career-oriented module selection help.", { h1: "SAP Training in Vancouver", schemas: [courseSchema("SAP Training in Vancouver", "Online SAP training in Vancouver covering SAP FICO, MM, SD, PP, HCM, SuccessFactors, ABAP, Ariba, S/4HANA, Basis, BW/HANA and BTP.", `${siteUrl}/sap-training-in-vancouver`, ["Vancouver", "British Columbia", "Canada"], "Online"), faqSchema()] }),
  page("sap-training-in-winnipeg", "SAP Training in Winnipeg, Canada | Online SAP Course | SV CurioTech", "Join SAP Training in Winnipeg, Canada with SV CurioTech. Learn SAP FICO, MM, SD, PP, Ariba, ABAP, HCM, SuccessFactors, Basis, S/4HANA and BW/HANA through practical online training and career guidance.", "SV CurioTech offers SAP training in Winnipeg, Canada through practical live online classes for students, graduates, working professionals and career switchers who want enterprise ERP skills. The course supports SAP FICO, SAP MM, SAP SD, SAP PP, SAP Ariba, SAP ABAP, SAP HCM, SAP SuccessFactors, SAP Basis, SAP S/4HANA and SAP BW/HANA learning with business process examples, procurement and finance workflows, module selection guidance, flexible online learning, trainer interaction, practical exercises, interview preparation and career-oriented SAP learning.", { h1: "SAP Training in Winnipeg", schemas: [courseSchema("SAP Training in Winnipeg", "Online SAP training in Winnipeg covering SAP FICO, MM, SD, PP, Ariba, ABAP, HCM, SuccessFactors, Basis, S/4HANA and BW/HANA.", `${siteUrl}/sap-training-in-winnipeg`, ["Winnipeg", "Manitoba", "Canada"], "Online"), faqSchema()] }),
...
function buildStaticContent(pageData) {
  const links = pageData.links
    ...
    .join("");
  return `<noscript><main><article><h1>${escapeHtml(pageData.h1)}</h1><p>${escapeHtml(pageData.body)}</p><h2>Helpful SAP training links</h2><ul>${links}</ul><p>Call SV CurioTech at +91 6361702540 or email svcuriotech@gmail.com for course guidance.</p></article></main></noscript>`;
}
