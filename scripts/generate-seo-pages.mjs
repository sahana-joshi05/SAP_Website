...
const locationPages = [
  ...
  ["sap-training-in-kalaburagi", "SAP Training in Kalaburagi | Certified SAP Courses with Placement Support", "Looking for SAP training in Kalaburagi? Get hands-on classes in SAP FICO, MM, SD, HR and ABAP from certified trainers. Weekday and weekend batches. Book a free demo today.", "Kalaburagi, Karnataka", "SAP Training in Kalaburagi helps freshers, graduates, working professionals and business owners build practical ERP skills close to home. SV CurioTech supports SAP FICO training, SAP MM training, SAP SD training, SAP HCM or HR training, SAP ABAP training and other SAP modules with live SAP system practice, small batches, real-time project scenarios, weekday and weekend batches, resume support, SAP-specific mock interviews, certification guidance and placement assistance for learners from finance, commerce, supply chain, HR, sales, engineering and technical backgrounds."],
...
const pages = [
  ...
  ...locationPages.map(([slug, title, description, area, body]) => {
    ...
    const extraLinks = slug === "sap-training-in-kalaburagi"
      ...
      ? [
          ["SAP FICO Course", `${siteUrl}/courses/sap-fico`],
          ["SAP MM Course", `${siteUrl}/courses/sap-mm`],
          ["SAP SD Course", `${siteUrl}/courses/sap-sd`],
          ["SAP ABAP Course", `${siteUrl}/courses/sap-abap`],
    ...
    return page(slug, title, description, body, {
      ...
      keywords: slug === "sap-training-in-kalaburagi" ? "SAP Training in Kalaburagi, SAP course in Kalaburagi, SAP institute in Kalaburagi, SAP training near me Kalaburagi, SAP FICO training Kalaburagi, SAP MM training Kalaburagi, SAP SD training Kalaburagi, SAP HR training Kalaburagi, SAP ABAP training Kalaburagi, SAP certification Kalaburagi, SAP placement support Kalaburagi" : slug === "sap-training-in-hsr-layout" ? "SAP Training in HSR Layout, SAP course in HSR Layout, SAP training institute in HSR Layout, SAP classes in HSR Layout, SAP course in Bengaluru, SAP institute in Bengaluru, SAP online training, SAP FICO training, SAP MM training, SAP SD training, SAP PP training, SAP ABAP training" : undefined,
      links: extraLinks,
